...
class Unit2SummaryA extends StatefulWidget {
  const Unit2SummaryA({Key? key}) : super(key: key);

  @override
  State<Unit2SummaryA> createState() => _Unit2SummaryAState();
}

class _Unit2SummaryAState extends State<Unit2SummaryA> {
            ...
            children: [
              ...
              Row(
                ...
                children: const [
                  ...
                  // ),
                  Text('Unit 2 Summary',style: TextStyle(fontSize: 24,fontWeight: FontWeight.bold),),
                  // SizedBox(
                  //   height: 60,
                  //   width: 60,
