...
class Unit5SummaryA extends StatefulWidget {
  const Unit5SummaryA({Key? key}) : super(key: key);

  @override
  State<Unit5SummaryA> createState() => _Unit5SummaryAState();
}

class _Unit5SummaryAState extends State<Unit5SummaryA> {
            ...
            children: [
              ...
              Row(
                ...
                children: const [
                  ...
                  // ),
                  Flexible(child: Text('Summary of Unit: ',style: TextStyle(fontSize: 24,fontWeight: FontWeight.bold),)),
                  // SizedBox(
                  //   height: 60,
                  //   width: 60,
