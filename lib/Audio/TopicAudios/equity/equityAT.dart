...
class EquityAT extends StatefulWidget {
  const EquityAT({Key? key}) : super(key: key);

  @override
  State<EquityAT> createState() => _EquityATState();
}

class _EquityATState extends State<EquityAT> {
            ...
            children: [
              ...
              Row(
                ...
                children: const [
                  ...
                  // ),
                  Text('Equity Example',style: TextStyle(fontSize: 24,fontWeight: FontWeight.bold),),
                  // SizedBox(
                  //   height: 60,
                  //   width: 60,
