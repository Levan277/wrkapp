...
class InstitutionalAT extends StatefulWidget {
  const InstitutionalAT({Key? key}) : super(key: key);

  @override
  State<InstitutionalAT> createState() => _InstitutionalATState();
}

class _InstitutionalATState extends State<InstitutionalAT> {
            ...
            children: [
              ...
              Row(
                ...
                children: const [
                  ...
                  // ),
                  Text('Institutional',style: TextStyle(fontSize: 24,fontWeight: FontWeight.bold),),
                  // SizedBox(
                  //   height: 60,
                  //   width: 60,
