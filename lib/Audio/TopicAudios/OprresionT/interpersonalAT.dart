...
class InterpersonalAT extends StatefulWidget {
  const InterpersonalAT({Key? key}) : super(key: key);

  @override
  State<InterpersonalAT> createState() => _InterpersonalATState();
}

class _InterpersonalATState extends State<InterpersonalAT> {
            ...
            children: [
              ...
              Row(
                ...
                children: const [
                  ...
                  // ),
                  Text('Interpersonal',style: TextStyle(fontSize: 24,fontWeight: FontWeight.bold),),
                  // SizedBox(
                  //   height: 60,
                  //   width: 60,
