...
class CulturalAT extends StatefulWidget {
  const CulturalAT({Key? key}) : super(key: key);

  @override
  State<CulturalAT> createState() => _CulturalATState();
}

class _CulturalATState extends State<CulturalAT> {
            ...
            children: [
              ...
              Row(
                ...
                children: const [
                  ...
                  // ),
                  Text('Cultural',style: TextStyle(fontSize: 24,fontWeight: FontWeight.bold),),
                  // SizedBox(
                  //   height: 60,
                  //   width: 60,
