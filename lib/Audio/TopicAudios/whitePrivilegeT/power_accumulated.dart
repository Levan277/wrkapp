...
class PowerOfAccum extends StatefulWidget {
  const PowerOfAccum({Key? key}) : super(key: key);

  @override
  State<PowerOfAccum> createState() => _PowerOfAccumState();
}

class _PowerOfAccumState extends State<PowerOfAccum> {
            ...
            children: [
              ...
              Row(
                ...
                children: const [
                  ...
                  // ),
                  Flexible(child: Text('Power of the Accumulated Power',style: TextStyle(fontSize: 24,fontWeight: FontWeight.bold),)),
                  // SizedBox(
                  //   height: 60,
                  //   width: 60,
