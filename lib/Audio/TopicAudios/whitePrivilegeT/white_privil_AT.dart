...
class WhitePrivilAT extends StatefulWidget {
  const WhitePrivilAT({Key? key}) : super(key: key);

  @override
  State<WhitePrivilAT> createState() => _WhitePrivilATState();
}

class _WhitePrivilATState extends State<WhitePrivilAT> {
            ...
            children: [
              ...
              Row(
                ...
                children: const [
                  ...
                  // ),
                  Text('White Privilege Example',style: TextStyle(fontSize: 24,fontWeight: FontWeight.bold),),
                  // SizedBox(
                  //   height: 60,
                  //   width: 60,
