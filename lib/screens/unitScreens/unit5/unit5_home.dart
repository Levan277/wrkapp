...
import 'package:wrkapp/screens/unitScreens/unit5/unit5main.dart';
...
class Unit5Home extends StatefulWidget {

  @override
  State<Unit5Home> createState() => _Unit5HomeState();

}

class _Unit5HomeState extends State<Unit5Home> {
  var _currentIndex = 0;
  @override
          ...
          child: Column(
            children: [
                      ...
                      child: Column(
                        children: [
                          Padding(
                            ...
                            child: Text("Unit 5:",style: TextStyle(color: Colors.pink,fontSize: 62),),
                          ),
                          Baseline(
                              baseline: 20,
                              baselineType: TextBaseline.alphabetic,
                              child: Text("Take Action",style: TextStyle(color: Colors.white, fontSize: 24),textAlign: TextAlign.center,))
                        ],
                      ),
              ...
              Container(
                ...
                child: Lottie.asset('assets/lottie/action.json'),
              ...
              Container(
                child: ElevatedButton(
                  ...
                  onPressed: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>Unit5Main()));
                  },
