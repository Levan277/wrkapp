...
class Unit3Home extends StatefulWidget {
  @override
  State<Unit3Home> createState() => _Unit3HomeState();
}

class _Unit3HomeState extends State<Unit3Home> {
  var _currentIndex = 0;
  @override
          ...
          child: Column(
            children: [
                      ...
                      child: Column(
                        children: [
                          Padding(
                            ...
                            child: Text("Unit 3:",style: TextStyle(color: Colors.pink,fontSize: 62),),
                          ),
                          Baseline(
                              baseline: 20,
                              baselineType: TextBaseline.alphabetic,
                              child: Text("Racism in Canada, The past & The Present",style: TextStyle(color: Colors.white, fontSize: 24),textAlign: TextAlign.center,))
                        ],
                      ),
              ...
              Container(
                ...
                child: Lottie.asset('assets/lottie/canada.json'),
