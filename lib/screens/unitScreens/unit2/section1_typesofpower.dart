              ...
              Center(
                child: Padding(
                  ...
                  child: Container(
                    ...
                    child: Center(child: Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Text("What is Superiority?",style: GoogleFonts.montserrat(color: Colors.white,fontSize: 20),textAlign: TextAlign.center
                        ,),
                    ),),
                  ),
                ),
              ),
AssetPlayerWidget(asset: 'assets/u2_sec1_superiority.mp3', description: ''),
              Center(
              ...
              Padding(
                ...
                child: Center(
                  child: Container(
                    ...
                    child: Center(child: Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Text("Example of Individual Power",style: GoogleFonts.montserrat(color: Colors.white,fontSize: 20),textAlign: TextAlign.center
                        ,),
                    ),),
                  ),
                ),
              ),
              AssetPlayerWidget(asset: 'assets/u2_Sec1_individualpower.mp3', description: ''),
              SizedBox(height: 15,),
              Padding(
                padding: EdgeInsets.fromLTRB(20, 0, 0, 0),
                child: Center(
              ...
              Padding(
                ...
                child: Center(
                  child: Container(
                    ...
                    child: Center(child: Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Text("Example of Institutional power",style: GoogleFonts.montserrat(color: Colors.white,fontSize: 20),textAlign: TextAlign.center
                        ,),
                    ),),
                  ),
                ),
              ),
              AssetPlayerWidget(asset: 'assets/u2_sec1_instpwr.mp3', description: ''),
              SizedBox(height: 15,),
              Padding(
                padding: EdgeInsets.fromLTRB(20, 0, 0, 0),
                child: Center(
