...
class WhiteSupremacyTopic extends StatefulWidget {
  const WhiteSupremacyTopic({Key? key}) : super(key: key);

  @override
  State<WhiteSupremacyTopic> createState() => _WhiteSupremacyTopicState();
}

class _WhiteSupremacyTopicState extends State<WhiteSupremacyTopic> {
  var _currentIndex = 0;
  @override
