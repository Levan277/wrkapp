...
import 'package:wrkapp/Audio/policy_audio_topic.dart';
...
class PolicyTopic extends StatefulWidget {
  const PolicyTopic({Key? key}) : super(key: key);

  @override
  State<PolicyTopic> createState() => _PolicyTopicState();
}

class _PolicyTopicState extends State<PolicyTopic> {
  var _currentIndex = 0;
  @override
