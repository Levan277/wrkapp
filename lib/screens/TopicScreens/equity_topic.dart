...
class EquityTopic extends StatefulWidget {
  const EquityTopic({Key? key}) : super(key: key);

  @override
  State<EquityTopic> createState() => _EquityTopicState();
}

class _EquityTopicState extends State<EquityTopic> {
  var _currentIndex = 0;
  @override
