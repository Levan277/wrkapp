...
import 'package:wrkapp/Audio/TopicAudios/racialization/racializationAT.dart';
...
class RacializationTopic extends StatefulWidget {
  const RacializationTopic({Key? key}) : super(key: key);

  @override
  State<RacializationTopic> createState() => _RacializationTopicState();
}

class _RacializationTopicState extends State<RacializationTopic> {
  var _currentIndex = 0;
  @override
